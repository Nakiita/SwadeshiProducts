                    ...
                    <div class="col-md-6">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="emailAddress" placeholder="email@janesfakedomain.net" />
                            </div>
                            <div class="form-group">
                                <label for="message">Your message</label>
                                <textarea class="form-control" id="message" rows="4" placeholder="Enter your question or message"></textarea>
                            </div>

                            <button

                                className="btn w-25 mb-2 btn btn-dark"
                                type="button"
                            >
                                Submit
                            </button>
