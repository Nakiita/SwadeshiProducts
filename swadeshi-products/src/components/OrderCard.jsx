...
const OrderCard = ({ product, user, quantity }) => {
    ...
    <div className="bg-white shadow-md rounded-lg p-4 flex flex-col md:flex-row mb-6">
      ...
      <div className="flex flex-1">
        ...
        <div className="mt-4 ml-4 flex-grow">
          ...
          <p className="text-sm text-gray-500">at {user.address}</p>
          <p>Quantity: {quantity}</p>
          <p>Price per item: Rs.{product.productPrice}</p>
          <p>Total Price: Rs.{totalPrice}</p> {/* Displaying total price */}
        </div>
      </div>

      {/* Status Indicators */}
      <div className="flex flex-col justify-between flex-1 mb-4 md:mb-0">
